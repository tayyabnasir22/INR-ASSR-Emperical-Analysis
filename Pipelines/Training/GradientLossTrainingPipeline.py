from Components.GradientL1Loss import GradientL1Loss
...
class GradientLossTrainingPipeline(BaseTrainingPipeline):
    def __init__(
        self,
    ...
    def InitModelObjectives(self, ):
        self.loss = GradientL1Loss(lambda_grad=self._lmbda)
